...
app.use("/.netlify/functions/routes/user", users_1.default);
app.use("/.netlify/functions/routes/shop", products_1.default);
app.use("/.netlify/functions/routes/cart", carts_1.default);
