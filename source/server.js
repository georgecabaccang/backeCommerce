...
app.use("/.netlify/source/api/user", users_1.default);
app.use("/.netlify/source/api/shop", products_1.default);
app.use("/.netlify/source/api/cart", carts_1.default);
app.use("/.netlify/source/api/orders", orders_1.default);
app.listen(8002, () => {
