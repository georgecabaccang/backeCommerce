...
app.use("/.netlify/src/routes/user", userRoutes);
app.use("/.netlify/src/routes/shop", productRoutes);
app.use("/.netlify/src/routes/cart", cartsRoutes);
app.use("/.netlify/src/routes/orders", ordersRoutes);
